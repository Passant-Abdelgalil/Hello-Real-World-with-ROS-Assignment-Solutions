...
import rospy
from week1ws_msgs.msg import BoxHeightInformation
from week1ws_msgs.srv import ConvertMetresToFeet, ConvertMetresToFeetRequest, ConvertMetresToFeetResponse
...
def box_height_info_callback(data):
    try:
        ...
        rospy.loginfo('%4.2f(m) = %4.2f feet', data.box_height, service_response.measurement_feet)
